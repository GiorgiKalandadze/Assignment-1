...
public class AppearancesTest {
	...
	public void testSameCount3() {
		...
		assertEquals(0, Appearances.sameCount(a, Arrays.asList(1, 1)));
		assertEquals(3, Appearances.sameCount(a, Arrays.asList(1, 2, 3, 4, 1)));
		assertEquals(5, Appearances.sameCount(a, Arrays.asList(1, 2, 3, 4, 5)));
	}
}
